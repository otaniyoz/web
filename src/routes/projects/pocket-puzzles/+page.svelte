...
<SectionGrid>
  ...
  <p class="grid-col17">
    {typographString(
      "Pocket puzzles is a collection of puzzles designed to fit in a pocket: easy to start playing, easy to put away."
    )}
  </p>
  <img
...
<SectionGrid>
  ...
  <p class="grid-col17">
    {typographString(
      "Right now, there are three puzzles. Each puzzle has three levels of difficulty and a scoring system based on the number of moves made."
    )}
  </p>
  <figure class="no-margin centered-visual grid small-gap three-columns">
  ...
  <p class="grid-col17">
    {typographString(
      "In Pairs, players need to find image pairs by tapping on shuffled tiles. On tap, tiles flip for a short duration to reveal hidden image."
    )}
  </p>
  <p class="grid-col17">
    {typographString(
